...
describe('<MediaObject />', () => {
  it('should support picUrl', () => {
    ...
    const { container } = render(<MediaObject title={title} picUrl={picUrl} />);
  ...
  it('should support picSize', () => {
    const title = 'Hello ChatUI';
    const picUrl = '//img.alicdn.com/tfs/TB1KwnKPqL7gK0jSZFBXXXZZpXa-221-57.svg';
    const { container } = render(<MediaObject title={title} picUrl={picUrl} picSize="sm" />);
  ...
  it('should support meta', () => {
    ...
    const picUrl = '//img.alicdn.com/tfs/TB1KwnKPqL7gK0jSZFBXXXZZpXa-221-57.svg';
    const { container } = render(<MediaObject title={title} picUrl={picUrl} meta={meta} />);
