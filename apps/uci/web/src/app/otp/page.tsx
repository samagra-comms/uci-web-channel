...
const OTPPage: NextPage = () => {
    ...
    const handleOTPSubmit: React.FormEventHandler = (event: React.FormEvent) => {
        ...
        const inputOTP: string = input.value1 + input.value2 + input.value3 + input.value4;
    ...
    const textOtpMsg = useMemo(() => 'We will send you a one time password on this Mobile Number', []);
                ...
                <div className={`${styles.main} ${backgroundColorToggle}`}>
                    ...
                    >
                        ...
                        <Box
                            ...
                            px="1rem"
                        >
                            <div className={styles.otpVerify}>{textOtpVerification}</div>
                            ...
                            <HStack style={{ marginTop: "34px", justifyContent: "center" }}>
                                <PinInput otp placeholder="">
                                    ...
                                    <PinInputComponent value={input.value1} onChange={handleOtpChange} valueKey="value1" />
                                    <PinInputComponent value={input.value2} onChange={handleOtpChange} valueKey="value2" />
                                    <PinInputComponent value={input.value3} onChange={handleOtpChange} valueKey="value3" />
                                    <PinInputComponent value={input.value4} onChange={handleOtpChange} valueKey="value4" />
                                </PinInput>
                            </HStack>
                            <Box width="100%">
                                {" "}
